...
var expectedDefaultUa = "Node.js/" + nodeVersion + "(" + osName + ") " + packageName + "@" + packageVersion;
...
describe("KintoneRequestConfigBuilder in Browser environment", function () {
    ...
    var kintoneRequestConfigBuilder;
    beforeEach(function () {
        platform_1.injectPlatformDeps(__assign(__assign({}, browserDeps), { getRequestToken: function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
