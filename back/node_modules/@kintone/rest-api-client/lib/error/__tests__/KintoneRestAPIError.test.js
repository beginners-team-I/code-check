...
describe("KintoneRestAPIError", function () {
    describe("constructor", function () {
        it("should set properties from an error", function () {
            ...
            var kintoneRestAPIError = new KintoneRestAPIError_1.KintoneRestAPIError(errorResponse);
            ...
            expect(kintoneRestAPIError.message).toBe("[" + errorResponse.status + "] [" + errorResponse.data.code + "] " + errorResponse.data.message + " (" + errorResponse.data.id + ")");
        });
        it("should set properties from an BulkRequest error", function () {
            ...
            expect(kintoneRestAPIError.message).toBe("[" + errorResponse.status + "] [" + errorResponseData.code + "] " + errorResponseData.message + " (" + errorResponseData.id + ")");
        });
        it("should throw an error if there is no error object in the results", function () {
            ...
            expect(function () {
                new KintoneRestAPIError_1.KintoneRestAPIError(errorResponse);
