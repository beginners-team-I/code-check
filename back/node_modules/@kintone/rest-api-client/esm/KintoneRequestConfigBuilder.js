...
var KintoneRequestConfigBuilder = /** @class */ (function () {
    ...
    KintoneRequestConfigBuilder.prototype.build = function (method, path, params, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_k) {
                switch (_k.label) {
                    case 0:
                        requestConfig = __assign(__assign(__assign({ method: method, headers: this.headers, url: "" + this.baseUrl + path }, (options ? options : {})), platformDeps.buildPlatformDependentConfig({
    ...
    KintoneRequestConfigBuilder.prototype.buildHeaders = function (params) {
        ...
        switch (this.auth.type) {
            case "password": {
                return __assign(__assign({}, commonHeaders), { "X-Cybozu-Authorization": Base64.encode(this.auth.username + ":" + this.auth.password) });
            }
            case "apiToken": {
