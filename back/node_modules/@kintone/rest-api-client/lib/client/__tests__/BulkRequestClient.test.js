...
describe("BulkRequestClient with guestSpaceId", function () {
    ...
    beforeEach(function () {
        ...
        mockClient = MockClient_1.buildMockClient(requestConfigBuilder);
        bulkRequestClient = new BulkRequestClient_1.BulkRequestClient(mockClient, GUEST_SPACE_ID);
    });
    ...
    it("should pass the path as a param with the guest space id to the http client", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    expect(mockClient.getLogs()[0].params.requests[0].api).toEqual("/k/guest/" + GUEST_SPACE_ID + "/v1/record.json");
                    return [2 /*return*/];
            }
        });
    }); });
