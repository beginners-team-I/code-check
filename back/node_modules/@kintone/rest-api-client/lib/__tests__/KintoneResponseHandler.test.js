    ...
    describe("handle", function () {
        ...
        it("should throw an error if KintoneAbortSearchError is enabled and x-cybozu-warning is'Filter aborted because of too many search results'", function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        responseHandler = new KintoneResponseHandler_1.KintoneResponseHandler({
                        ...
                        return [4 /*yield*/, expect(responseHandler.handle(Promise.resolve(response))).rejects.toThrow(KintoneAbortSearchError_1.KintoneAbortSearchError)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(responseHandler.handle(Promise.reject(new HttpClientErrorImpl("", errorResponse)))).rejects.toThrow(KintoneRestAPIError_1.KintoneRestAPIError)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, expect(responseHandler.handle(Promise.reject(new HttpClientErrorImpl("", errorResponse)))).rejects.toThrow(errorResponse.status + ": " + errorResponse.statusText)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
