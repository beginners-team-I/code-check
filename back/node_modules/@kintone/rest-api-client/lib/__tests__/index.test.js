...
describe("index", function () {
    it("should export each error class properly", function () {
        ...
        expect(index.KintoneAbortSearchError).toBe(KintoneAbortSearchError_1.KintoneAbortSearchError);
        expect(index.KintoneAllRecordsError).not.toBeUndefined();
        expect(index.KintoneAllRecordsError).toBe(KintoneAllRecordsError_1.KintoneAllRecordsError);
        expect(index.KintoneRestAPIError).not.toBeUndefined();
        expect(index.KintoneRestAPIError).toBe(KintoneRestAPIError_1.KintoneRestAPIError);
    });
});
