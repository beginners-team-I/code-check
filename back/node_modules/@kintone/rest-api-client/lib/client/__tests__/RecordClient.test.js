            ...
            it("should append `$id` if `fields` is specified and doesn't contain `$id`", function () { return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            expect(mockClient.getLogs()[0].params.fields.sort()).toEqual(__spreadArray(__spreadArray([], params.fields), ["$id"]).sort());
                            return [2 /*return*/];
                    }
                });
            }); });
    ...
    describe("addAllRecords", function () {
        ...
        describe("success", function () {
            ...
            it("should return merged result of each bulkRequest's result", function () {
                ...
                var expected = __spreadArray(__spreadArray([], mockResponse.results.reduce(accumulateResponse, [])), mockResponse2.results.reduce(accumulateResponse, []));
    ...
    describe("updateAllRecords", function () {
        ...
        describe("success", function () {
            ...
            it("should return merged result of each bulkRequest's result", function () {
                ...
                var expected = __spreadArray(__spreadArray([], mockResponse.results), mockResponse2.results).reduce(accumulateResponse, []);
                expect(response.records).toStrictEqual(expected);
            });
        });
        describe("response error", function () {
